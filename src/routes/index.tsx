...
import BuyTradeImage from '~/components/landing/buy-trade-image'
import PartnerImage from '~/components/landing/partner-image'
...
export default component$(() => {
  ...
  return (
    <div class='w-full'>
        ...
        <Section>
          <div class='col-span-12 lg:col-span-6 mt-12 xl:mt-10 space-y-4 sm:space-y-6 px-6 text-center sm:text-left'>
            ...
            <h1
              ...
              Helping each{' '}
              <span class='text-header-gradient'>other can make</span> world
              better
            </h1>
            <p
              data-aos='fade-down'
            ...
            <div
              ...
              <Button class='max-w-full px-8 py-4 bg-gradient-to-r from-[#468ef9] to-[#0c66ee] border border-[#0c66ee] text-white'>
                Donate now
              </Button>
        ...
        <Section>
          ...
          <div
            ...
            <p class='paragraph'>
              ...
              After attempting to hand out bread to hungry migrants and needing
              rescue from the local shopkeepers from the ensuing melee, our
              first missionary realized that she needed to change her
              strategy...
            </p>
            <div class='space-y-6 lg:pr-12'>
              <Button class='w-full px-5 py-4 bg-blue-gradient text-white text-base font-medium'>
                Learn More{' '}
              </Button>
            </div>
          </div>
        ...
        <Section data-aos='fade-down'>
          ...
          <div class='col-span-12 lg:col-span-5 space-y-6 px-4 sm:px-6 mt-20'>
            <h2 class='text-4xl font-semibold'>
              Introducing the <span class='text-header-gradient'>NEFA</span>{' '}
              Credit Card
            </h2>
            <p class='paragraph'>
            ...
            <Button class='w-full sm:max-w-[240px] px-10 py-4 bg-inherit text-gradient border border-[#0c66ee] text-base'>
              Join the waitlist
            </Button>
          </div>
        </Section>
        ...
        <div class='relative max-w-screen-xl px-4 sm:px-2 mx-auto grid grid-cols-12 gap-x-6'>
          ...
          <div
            ...
            <div class='flex flex-col sm:flex-row'>
              <Button class='px-10 py-4 bg-inherit text-gradient border border-[#4A8FF6] text-'>
                Get Started
              </Button>
              <Button class='bg-inherit text-[#4A8FF6] px-10 py-4 text-center underline rounded-full'>
                Learn More
              </Button>
            </div>
          </div>
      ...
      <section class='w-full my-24'>
        <Section>
          ...
          <div
            ...
            <span class='text-base text-gradient font-semibold uppercase mb-4 sm:mb-2'>
              Support
            </span>
            ...
            <ul class='shadow-box'>
              {[
                ...
                {
                  title:
                    'How can make sure the funds I donated reached the people that need it?',
                  description:
      ...
      <section
        id='testimony'
        class='bg-trading-tools relative max-w-full sm:mx-4 xl:mx-10 my-24 overflow-hidden'>
        <div class='w-full py-16 flex flex-col items-center'>
          <h2
            data-aos='flip-down'
            class='text-3xl sm:text-4xl font-semibold text-center'>
